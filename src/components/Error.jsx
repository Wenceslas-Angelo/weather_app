...
const Error = ({ setSearchTerm }) => {
  return (
    ...
    >
      <div className="flex justify-center items-center flex-col p-5 rounded-xl shadow-2xl shadow-black/50 bg-[#181818]/80">
        ...
        <Search setSearchTerm={setSearchTerm} absoluteBtn={false} />
      </div>
    </div>
  );
};
